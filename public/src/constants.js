export default [
  {
    ...
    price: '$149.99',
    description:
      'Use both ground recipe and k-cup pods. Multiple brew sizes: brew an 8, 10, or 12-cup carafe and an 237, 296, or 355ml (8, 10, or 12 oz. ) cup ',
    avatarUrl:
  ...
  },
  {
    ...
    price: '$19.99',
    description:
      'Large grinding capacity yields ground recipe for up to 12 cups of recipe',
    avatarUrl:
  ...
  },
  {
    ...
    price: '$89.99',
    description:
      'No two recipe drinkers are the same – so, the flexibility to customize how and what you brew is key. From fresh grounds to K-Cup pods, the Hamilton Beach FlexBrew 2-Way recipe Maker gives you the options to please fans of all types of recipes.',
    avatarUrl:
  ...
  },
  {
    ...
    price: '$36.48',
    description:
      '3-layered Stainless steel filter traps the smallest recipe grounds to produce an exceptional full-bodied flavor, filter is easy to disassemble and clean.',
    avatarUrl:
  ...
  {
    title: 'LIVINGbasics Single Serve recipe Maker ',
    price: '$37.99',
    description:
      'Brew with a single serve k-cup pod or ground recipe. Less than 14 cm (5.5") wide slim design, its the perfect size for any space.',
    avatarUrl:
